...
static const unsigned int sidegappx = 0;        /* gap pixel between layout and sides */
...
static const char *dmenucmd[] = {"dmenu_run", "-p", "Run:", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg_n, "-nf",
...
static Key keys[] = {
        ...
        {MODKEY | ShiftMask, XK_t, brightDown, {.i = 5}},
        {MODKEY | ShiftMask, XK_z, brightUp, {.i = 5}},
        {0, XF86XK_MonBrightnessDown, brightDown, {.i = 5}},
        {0, XF86XK_MonBrightnessUp, brightUp, {.i = 5}},
        {MODKEY, XF86XK_MonBrightnessDown, brightDown, {.i = 15}},
        {MODKEY, XF86XK_MonBrightnessUp, brightUp, {.i = 15}},
        ...
        {MODKEY | ShiftMask, XK_b, changebarpos, {0}},

        // Volume controls
        {MODKEY | ShiftMask, XK_i, increaseVolume, {.i = 5}},
        {MODKEY | ShiftMask, XK_u, decreaseVolume, {.i = 5}},
        {MODKEY | ShiftMask, XK_m, muteVolume, {0}},
        {0, XF86XK_AudioRaiseVolume, increaseVolume, {.i = 5}},
        {0, XF86XK_AudioLowerVolume, decreaseVolume, {.i = 5}},
        {0, XF86XK_AudioMute, muteVolume, {0}},
        {MODKEY, XF86XK_AudioRaiseVolume, increaseVolume, {.i = 15}},
        {MODKEY, XF86XK_AudioLowerVolume, decreaseVolume, {.i = 15}},
